...
document.querySelector("#table-weather-dublin tbody").innerHTML = strTableRows;
    ...
    function change_background() {
        ...
        let n = d.getHours();
        if (n > 23 || n <= 6) {
            document.querySelector(".theme-js").style.backgroundImagejpg = "url('assets/img/dublin-night.jpg')";
         }else{
            document.querySelector(".theme-is").style.backgroundImagejpg ="url('assets/img/dublin-day.jpg')";
         }
    }
change_background();
